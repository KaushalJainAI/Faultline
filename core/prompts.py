...
0. **Deterministic Checker (run_deterministic_checks)**: Runs the pipeline-first baseline checks for syntax, imports, dependency conflicts, collection failures, and dependency root-cause propagation.
